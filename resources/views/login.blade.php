...
@endif
        ...
        <form action="/user/ceklogin" method="POST">
            @csrf
            <img class="mb-4" src="https://w7.pngwing.com/pngs/544/1/png-transparent-computer-icons-login-icon-design-others-logo-silhouette-share-icon.png" alt="" width="100"
                height="125">
            ...
            <p class="mt-5 mb-3 text-muted">&copy; 72200381</p>
        </form>
    </main>
